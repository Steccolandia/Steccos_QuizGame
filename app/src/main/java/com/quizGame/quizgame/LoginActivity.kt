...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //next 3 lines are standard, for activities
        //now we can access the components in the login activity using the loginBinding object
        ...
        loginBinding.textViewSignup.setOnClickListener {
            ...
            //we don't write finish() as the signup activity is child of login activity, and we want to be able to go back
        }
    ...
    override fun onStart() {
     ...
     fun signInGoogle() {
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("769827441807-63anmni6u225qqlbqkabjehr8g4pdq0b.apps.googleusercontent.com")
            .requestEmail().build()
